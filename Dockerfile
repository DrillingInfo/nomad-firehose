...
WORKDIR /go/src/github.com/Drillinginfo/nomad-firehose/
COPY . /go/src/github.com/Drillinginfo/nomad-firehose/
...
COPY --from=0 /go/src/github.com/Drillinginfo/nomad-firehose/build/nomad-firehose /usr/local/bin/
CMD [ "nomad-firehose" ]
